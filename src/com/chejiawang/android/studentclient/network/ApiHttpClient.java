...
public class ApiHttpClient {
	...
	public static void get(String partUrl, RequestParams params, AsyncHttpResponseHandler handler){
		//String url = "http://120.26.61.165/DTAServer/rest/orderRecord/getCoachPrecontractedRecord?coach_id=1&sort=order_time&dir=desc&start=0&length=10&order_Status=3";
